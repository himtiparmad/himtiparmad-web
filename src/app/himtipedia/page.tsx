...
export default function Himtipedia() {
  return (
    <div className="w-full max-w-[1400px] mx-auto px-4 py-8 mt-32">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col justify-center items-center bg-white p-8 rounded-lg shadow">
          <h1 className="text-4xl text-center font-normal text-brand-main mb-4">
            Explore the world of HIMTI Paramadina
          </h1>
      ...
      <div className="mt-8 bg-white p-8 rounded-lg shadow">
        <h2 className="text-2xl font-normal mb-10">What are you looking for</h2>
              ...
              <div>
                <Link href={item.link} legacyBehavior>
                  <a className="flex items-center justify-between w-full">
                    <h3 className="text-lg font-medium text-brand-main ">
                      {item.title}
                    </h3>
